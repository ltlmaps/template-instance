...
`SOURCECRED_GITHUB_TOKEN=<token>`. The key should be read-only without any special
...
access your Discord server, you need to generate a "bot token" and paste it in the `.env` file as well as adding it
